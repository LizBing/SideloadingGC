...
#define EPSILON_SIDELOADING_GCCAUSE_ENUM(enum_name, ...) enum_name ,
#define EPSILON_SIDELOADING_GCCAUSE_RET_CSTR(enum_name, cstr) \
    case enum_name: \
        return cstr;
...
#define EPSILON_SIDELOADING_GCCAUSES_DO(f) \
